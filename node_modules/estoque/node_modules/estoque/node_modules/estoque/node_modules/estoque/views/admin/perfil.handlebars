...
<div class="container-fluid">
    ...
    <div id="divValores">
        ...
        <div id="divDados" class="container-fluid">
            <p>Olá! Bem-vindo, {{dados.nome}}</p>
        </div>
       
        <p>Telefone: {{dados.telefone}}</p>
        <p>Função: {{dados.funcao}}</p>
        <p>Veiculo: {{dados.veiculo}}</p>

        <div id="divBotoes"> 

          <!-- Botão de edição -->
          <a href="/admin/dados/edit/{{dados._id}}">
          ...
          <a href="/admin/horas">
                <svg xmlns="http://www.w3.org/2000/svg" width="31" height="31" fill="currentColor" class="bi bi-clock-fill" viewBox="0 0 16 16">
...
{{else}}
  <!-- Mensagem exibida se o objeto "dado" não existir -->
